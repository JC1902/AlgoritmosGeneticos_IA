...
def main():
    ...
    while True:
        ...
        try:
            ...
            print("Seleccionando el mejor cromosoma de los últimos cromosomas generados.")
            mejor_cromosoma = seleccionar_mejor_cromosoma(ultimos_cromosomas)
            valor_objetivo = evaluar(mejor_cromosoma)
            print("Mejor cromosoma encontrado:", mejor_cromosoma)
